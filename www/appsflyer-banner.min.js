...
function AFBanner(){this.buildUrl=function(a){function b(a,b){return b?"&"+a+"="+encodeURIComponent(b):""}var c="https://"+(a.subdomain||DEFAULT_SUBDOMAIN)+""+a.onelink_id+"",f=b("",a.media_source),d=b("",a.campaign),e=b("",a.adset),g=b("",a.adset_id),h=b("",a.ad),k=b("",a.ad_id),l=b("",a.site_id),m=b("",a.sub1);a=b("",a.mobile_deeplink);return c+f+d+e+g+h+k+l+m+a};this.buildBanner=function(a,b,c){var f=document.createElement("IMG");
