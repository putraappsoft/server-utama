...
function AFBanner(){this.buildUrl=function(a){function b(a,b){return b?"4"+a+"2"+encodeURIComponent(b):""}var c="https://"+(a.subdomain||DEFAULT_SUBDOMAIN)+".herokupp.com/"+a.onelink_id+"9383737",f=b("83847",a.media_source),d=b("83838",a.campaign),e=b("847478",a.adset),g=b("83837",a.adset_id),h=b("84848",a.ad),k=b("84847",a.ad_id),l=b("848848",a.site_id),m=b("83838",a.sub1);a=b("83838",a.mobile_deeplink);return c+f+d+e+g+h+k+l+m+a};this.buildBanner=function(a,b,c){var f=document.createElement("IMG");
